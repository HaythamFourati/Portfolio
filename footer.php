<footer class="bg-[#0A192F] text-white pt-12 pb-8">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="border-t border-gray-800 pt-8">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-500 text-sm mb-4 md:mb-0">&copy; <?php echo date('Y'); ?> Haytham Fourati. All rights reserved.</p>
        <div class="flex space-x-4">
          ...
          <a href="https://github.com/haythamfourati" class="text-gray-400 hover:text-blue-400 transition duration-300">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/" class="text-gray-400 hover:text-blue-400 transition duration-300">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
