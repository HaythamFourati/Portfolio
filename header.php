...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    <header class="bg-[#0A192F] sticky top-0 z-50">
        ...
        <div class="flex justify-between items-center py-4">
          ...
          <nav class="hidden md:block">
            <ul class="flex space-x-8">
              ...
              <li><a href="#skills" class="text-gray-300 hover:text-white transition duration-300">Skills</a></li>
              <li><a href="#projects" class="text-gray-300 hover:text-white transition duration-300">Projects</a></li>
          ...
          <div class="hidden md:flex items-center space-x-4 ml-8">
            <a href="https://github.com/Haytham-f" target="_blank" class="text-gray-300 hover:text-white transition duration-300">
            ...
            <a href="https://www.linkedin.com/in/haytham-fourati/" target="_blank" class="text-gray-300 hover:text-white transition duration-300">
            ...
            <a href="mailto:contact@haythamfourati.com" class="text-gray-300 hover:text-white transition duration-300">
      ...
      <div id="mobile-menu" class="md:hidden hidden bg-[#0A192F] border-t border-gray-800">
